    ...
    async function (req, res) {
      ...
      await tryCatch(
        ...
        async () => {
          ...
          const emailError = await checkUserExists('email', email, errorMsg, res);
          if (emailError[0] !== 404) {
          ...
          const usernameError = await checkUserExists('username', username, errorMsg, res)
    ...
    async function (req, res) {
      ...
      await tryCatch(
        ...
        async () => {
          ...
          const user = await checkUserExists('email', email, 'User not found', res);
          if (user[0] == 404) {
    ...
    async function (req, res) {
      ...
      await tryCatch(
        ...
        async () => {
          ...
          const user = await checkUserExists("passwordResetToken", resetToken, "Invalid reset token", res);
          if (user[0] == 404) {
